...
// --- TIMELINE CON SCROLL INFINITO (PAGINACIÓN) ---
router.get("/timeline/all", async (req, res) => {
  try {
    // Recibimos la página por URL (si no envían nada, es la 1)
    const page = parseInt(req.query.page) || 1;
    const limit = parseInt(req.query.limit) || 5; // Cargamos de 5 en 5 para probar rápido
    
    // Calculamos cuántas fotos hay que saltarse
